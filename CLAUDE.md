...
- [ ] 三条侧线 + 产品化——**方向全部定案**（2026-08-14）：中文为主+术语中英双语；剧场模式方案 A；样板页已过目通过（`docs/design/`，提交 a2984c5）；**侧线不并列、按关卡编织进各课（每课侧重不同）**。阶段 3＝周六课后**按课打包**落地，详见 `docs/调研-三侧线与产品化-20260814.md` 定案节。
