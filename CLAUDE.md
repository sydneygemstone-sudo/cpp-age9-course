...
- [ ] 三条侧线 + 产品化——**方向已拍板**（2026-08-14）：内容中文为主、编程术语中英双语；剧场模式方案 A；调研见 `docs/调研-三侧线与产品化-20260814.md`。阶段 2 已产出（`docs/design/`：tokens + 3 样板页，提交 a2984c5），**等 Dean 过目**后进阶段 3 批量落地（周六课后）。
