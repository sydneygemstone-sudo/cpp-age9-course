...
(function () {
  ...
  var lesson2 = {
    ...
    activities: [
       ...
       * program 是带 bug 版：energy > 5，能量正好 5 时不开门 → 应改为 >=
       * =================================================================== */
      {
       ...
       * =================================================================== */
      {
        ...
        evidenceRule: {
          dimension: 'D11',
          note: '解释能力与元认知：能否不借助追问说全"何时检查、为何只走一边"？【第2次路径复核点：完成后教师端应显示 pathSuggestion 供确认。】'
        },
        teacherCards: {
          truth: '条件在执行到 if 时被计算一次，结果只有真或假；真走 if 块、假走 else 块。孩子若能自己讲出这两点，说明分支的心智模型已建立——这是本课最重要的一条证据，也是第 2 次路径复核的核心输入。',
